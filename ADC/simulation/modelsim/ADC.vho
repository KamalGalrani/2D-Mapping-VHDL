...
-- BIN	=>  Location: PIN_2,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 16mA
...
-- Equation(s):
-- \send_data|tx_clk_count\(4) = DFFEAS((((\send_data|Add0~45_combout\ & !\send_data|Equal0~3\))), GLOBAL(\CLK~combout\), VCC, , , , , , )
...
PORT MAP (
	clk => \CLK~combout\,
	datac => \send_data|Add0~45_combout\,
...
-- Equation(s):
-- \send_data|Equal0~2\ = (!\send_data|tx_clk_count\(5) & (!\send_data|tx_clk_count\(3) & (B1_tx_clk_count[2] & \send_data|tx_clk_count\(4))))
...
PORT MAP (
	clk => \CLK~combout\,
	dataa => \send_data|tx_clk_count\(5),
	datab => \send_data|tx_clk_count\(3),
	datac => \send_data|Add0~50_combout\,
	datad => \send_data|tx_clk_count\(4),
	aclr => GND,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \send_data|tx_clk_count\(3) = DFFEAS((((\send_data|Add0~60_combout\ & !\send_data|Equal0~3\))), GLOBAL(\CLK~combout\), VCC, , , , , , )
...
PORT MAP (
	clk => \CLK~combout\,
	datac => \send_data|Add0~60_combout\,
	datad => \send_data|Equal0~3\,
	aclr => GND,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \send_data|tx_clk_count\(11) = DFFEAS((((\send_data|Add0~15_combout\))), GLOBAL(\CLK~combout\), VCC, , , , , , )
...
-- Equation(s):
-- \send_data|Equal0~3\ = (\send_data|Equal0~1\ & (\send_data|tx_clk_count\(1) & (\send_data|Equal0~2\ & \send_data|Equal0~0\)))
...
PORT MAP (
	clk => \CLK~combout\,
	dataa => \send_data|Equal0~1\,
	datab => \send_data|tx_clk_count\(1),
	datac => \send_data|Equal0~2\,
	datad => \send_data|Equal0~0\,
	aclr => GND,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \send_data|tx_clk_count\(6) = DFFEAS((((!\send_data|Equal0~3\ & \send_data|Add0~20_combout\))), GLOBAL(\CLK~combout\), VCC, , , , , , )
...
-- Equation(s):
-- \send_data|Add0~5_combout\ = \send_data|tx_clk_count\(12) $ ((((!(!\send_data|Add0~12\ & \send_data|Add0~17\) # (\send_data|Add0~12\ & \send_data|Add0~17COUT1_92\)))))
...
-- Equation(s):
-- \send_data|tx_clk_count\(5) = DFFEAS((((\send_data|Add0~55_combout\))), GLOBAL(\CLK~combout\), VCC, , , , , , )
...
-- Equation(s):
-- \send_data|tx_clk_count\(7) = DFFEAS(GND, GLOBAL(\CLK~combout\), VCC, , , \send_data|Add0~35_combout\, , , VCC)
...
PORT MAP (
	clk => \CLK~combout\,
	datac => \send_data|Add0~35_combout\,
	aclr => GND,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \send_data|transmitter|step\(3) = DFFEAS(\send_data|transmitter|step\(3) $ (((\send_data|transmitter|step\(2) & (\send_data|transmitter|step\(1) & \send_data|transmitter|step\(0))))), GLOBAL(\send_data|tx_clk_tick~regout\), 
...
-- Equation(s):
-- \send_data|transmitter|process_1~0_combout\ = (\send_data|transmitter|step\(1) & (\send_data|transmitter|step\(3) & (!\send_data|transmitter|step\(2) & !\send_data|transmitter|step\(0))))
...
PORT MAP (
	dataa => \send_data|transmitter|step\(1),
	datab => \send_data|transmitter|latch\(6),
...
PORT MAP (
	...
	datad => \send_data|transmitter|latch\(0),
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- pragma translate_on
PORT MAP (
	datab => \send_data|transmitter|TX~1_combout\,
...
PORT MAP (
	clk => \send_data|tx_clk_tick~regout\,
	dataa => \send_data|transmitter|TX~0_combout\,
	datab => \send_data|transmitter|process_1~0_combout\,
...
\err[1]~5\ : maxv_lcell
-- Equation(s):
-- \err[1]~5_combout\ = \ADC~combout\(1) $ (\THR~combout\(1) $ ((!\err[0]~2\)))
-- \err[1]~7\ = CARRY((\ADC~combout\(1) & (\THR~combout\(1) & !\err[0]~2\)) # (!\ADC~combout\(1) & ((\THR~combout\(1)) # (!\err[0]~2\))))
-- \err[1]~7COUT1_51\ = CARRY((\ADC~combout\(1) & (\THR~combout\(1) & !\err[0]~2COUT1_49\)) # (!\ADC~combout\(1) & ((\THR~combout\(1)) # (!\err[0]~2COUT1_49\))))
...
\err[5]~25\ : maxv_lcell
-- Equation(s):
-- \err[5]~25_combout\ = \ADC~combout\(5) $ (\THR~combout\(5) $ ((!\err[4]~22\)))
-- \err[5]~27\ = CARRY((\ADC~combout\(5) & (\THR~combout\(5) & !\err[4]~22\)) # (!\ADC~combout\(5) & ((\THR~combout\(5)) # (!\err[4]~22\))))
-- \err[5]~27COUT1_57\ = CARRY((\ADC~combout\(5) & (\THR~combout\(5) & !\err[4]~22\)) # (!\ADC~combout\(5) & ((\THR~combout\(5)) # (!\err[4]~22\))))
...
-- Equation(s):
-- \LessThan0~1_combout\ = (\err[6]~30_combout\) # ((\err[7]~35_combout\) # ((\err[4]~20_combout\) # (\err[5]~25_combout\)))
...
-- Equation(s):
-- \LessThan0~0_combout\ = (\err[3]~15_combout\) # ((\err[2]~10_combout\) # ((\err[1]~5_combout\) # (\err[0]~0_combout\)))
...
PORT MAP (
	...
	datac => \err[1]~5_combout\,
	datad => \err[0]~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\BIN~reg0\ : maxv_lcell
-- Equation(s):
-- \BIN~reg0_regout\ = DFFEAS(((\Add0~0_combout\ & ((\LessThan0~1_combout\) # (\LessThan0~0_combout\)))), GLOBAL(\CLK~combout\), VCC, , , , , , )
