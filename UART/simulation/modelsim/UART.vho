...
SIGNAL \transmitter|comb~0_combout\ : std_logic;
...
-- Equation(s):
-- \Equal0~2\ = (!tx_clk_count(5) & (!tx_clk_count(3) & (tx_clk_count[2] & tx_clk_count(4))))
...
PORT MAP (
	clk => \CLK~combout\,
	dataa => tx_clk_count(5),
	datab => tx_clk_count(3),
	datac => \Add0~50_combout\,
	datad => tx_clk_count(4),
	aclr => \RST~combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- tx_clk_count(4) = DFFEAS((\Add0~45_combout\ & (((!\Equal0~3\)))), GLOBAL(\CLK~combout\), !GLOBAL(\RST~combout\), , , , , , )
...
-- Equation(s):
-- tx_clk_count(7) = DFFEAS(GND, GLOBAL(\CLK~combout\), !GLOBAL(\RST~combout\), , , \Add0~35_combout\, , , VCC)
...
-- Equation(s):
-- \Equal0~1\ = (!tx_clk_count(7) & (tx_clk_count(6) & (!tx_clk_count[9] & !tx_clk_count(8))))
...
-- Equation(s):
-- \Equal0~3\ = (tx_clk_count(1) & (\Equal0~2\ & (\Equal0~1\ & \Equal0~0\)))
...
-- Equation(s):
-- tx_clk_count(12) = DFFEAS((((\Add0~5_combout\ & !\Equal0~3\))), GLOBAL(\CLK~combout\), !GLOBAL(\RST~combout\), , , , , , )
...
-- Equation(s):
-- \transmitter|Equal2~0_combout\ = (\transmitter|step\(1) & (!\transmitter|step\(0) & (\transmitter|step\(3) & !\transmitter|step\(2))))
...
\transmitter|comb~0\ : maxv_lcell
-- Equation(s):
-- \transmitter|comb~0_combout\ = (\WR~combout\) # (((\transmitter|ready~regout\)))
...
-- Equation(s):
-- \transmitter|trigger~combout\ = ((\transmitter|comb~0_combout\ & ((\WR~combout\) # (\transmitter|trigger~combout\))))
...
PORT MAP (
	dataa => \WR~combout\,
	datac => \transmitter|comb~0_combout\,
...
-- Equation(s):
-- \transmitter|TX~1_combout\ = (\RST~combout\) # ((!\WR~combout\ & (\transmitter|trigger~combout\ & \transmitter|Equal2~0_combout\)))
...
-- Equation(s):
-- \transmitter|step\(2) = DFFEAS((\transmitter|step\(2) $ (((\transmitter|step\(1) & \transmitter|step\(0))))), GLOBAL(\tx_clk_tick~regout\), !\transmitter|TX~1_combout\, , , , , , )
...
-- Equation(s):
-- \transmitter|step\(3) = DFFEAS(B1_step[3] $ (((\transmitter|step\(1) & (\transmitter|step\(0) & \transmitter|step\(2))))), GLOBAL(\tx_clk_tick~regout\), !GLOBAL(\transmitter|ready~1_combout\), , , VCC, GLOBAL(\RST~combout\), , )
...
-- Equation(s):
-- \transmitter|step\(0) = DFFEAS((!\transmitter|step\(0) & (((\transmitter|step\(2)) # (!\transmitter|step\(3))) # (!\transmitter|step\(1)))), GLOBAL(\tx_clk_tick~regout\), !\transmitter|TX~1_combout\, , , , , , )
...
-- Equation(s):
-- \transmitter|TX~regout\ = DFFEAS((\transmitter|step\(1) & ((\transmitter|step\(0) $ (\transmitter|step\(2))))) # (!\transmitter|step\(1) & (((\transmitter|step\(2)) # (!\transmitter|step\(0))) # (!\transmitter|step\(3)))), GLOBAL(\tx_clk_tick~regout\), 
